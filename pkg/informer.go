...
func NewInformer[T ComparableObject, TL any, PT ptrTL[TL]](ctx context.Context, c client.WithWatch, opts ...CollectorOption) IndexableCollection[T] {
...
func NewTypedClientInformer[T ComparableObject, TL runtime.Object](ctx context.Context, c TypedClient[TL], opts ...CollectorOption) IndexableCollection[T] {
	return NewListerWatcherInformer[T](&cache.ListWatch{
...
func NewListerWatcherInformer[T ComparableObject](lw cache.ListerWatcher, opts ...CollectorOption) IndexableCollection[T] {
	i := informer[T]{
